  ...
  describe "sorted set commands" do
    ...
    test "ZPOPMAX replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "pop_test")
    ...
    test "ZREMRANGEBYRANK replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "rank_test", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "score_test", 0, -1, false)
    ...
    test "ZUNIONSTORE replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zset_union")
        redis_score = Redix.command!(redis, ["ZSCORE", "zset_union", "b"])
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "zset_union", "b")
    ...
    test "ZINTERSTORE replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zset_inter")
        redis_members = Redix.command!(redis, ["ZRANGE", "zset_inter", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zset_inter", 0, -1, false)
    ...
    test "ZDIFFSTORE replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zdiff_result")
        redis_members = Redix.command!(redis, ["ZRANGE", "zdiff_result", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zdiff_result", 0, -1, false)
    ...
    test "ZRANGESTORE by rank replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_dest")
        redis_members = Redix.command!(redis, ["ZRANGE", "zrangestore_dest", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zrangestore_dest", 0, -1, false)
    ...
    test "ZRANGESTORE with REV replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_rev_dest")
        redis_members = Redix.command!(redis, ["ZRANGE", "zrangestore_rev_dest", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zrangestore_rev_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_score_dest")
        redis_members = Redix.command!(redis, ["ZRANGE", "zrangestore_score_dest", "0", "-1"])

        {:ok, ts_members} =
          Veidrodelis.zrange(vdr_id(), 0, "zrangestore_score_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYLEX replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_lex_dest")
        redis_members = Redix.command!(redis, ["ZRANGE", "zrangestore_lex_dest", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zrangestore_lex_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE with LIMIT replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_limit_dest")
        redis_members = Redix.command!(redis, ["ZRANGE", "zrangestore_limit_dest", "0", "-1"])

        {:ok, ts_members} =
          Veidrodelis.zrange(vdr_id(), 0, "zrangestore_limit_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE with REV and LIMIT replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zrangestore_complex_dest")

        {:ok, ts_members} =
          Veidrodelis.zrange(vdr_id(), 0, "zrangestore_complex_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYRANK with negative indices", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zr_neg_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYRANK with max greater than last element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zr_maxgt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYRANK with min greater than max", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zr_minmax_dest")
    ...
    test "ZRANGESTORE BYRANK starting beyond last element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zr_beyond_dest")
    ...
    test "ZRANGESTORE BYSCORE with min less than first element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zs_minlt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE with max greater than last element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zs_maxgt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE with min greater than max", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zs_minmax_dest")
    ...
    test "ZRANGESTORE BYSCORE with LIMIT greater than available elements", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zs_limitgt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYSCORE with -inf and +inf", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zs_inf_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYLEX with min less than first element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zl_minlt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYLEX with max greater than last element", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zl_maxgt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYLEX with min greater than max", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zl_minmax_dest")
    ...
    test "ZRANGESTORE BYLEX with LIMIT greater than available elements", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zl_limitgt_dest", 0, -1, false)
    ...
    test "ZRANGESTORE BYLEX with - and + bounds", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zl_unbounded_dest", 0, -1, false)
    ...
    test "ZMPOP replicates as ZPOPMAX", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "zmpop_test")
        redis_members = Redix.command!(redis, ["ZRANGE", "zmpop_test", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "zmpop_test", 0, -1, false)
    ...
    test "BZMPOP replicates as ZPOPMIN", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "bzmpop_test")
        redis_members = Redix.command!(redis, ["ZRANGE", "bzmpop_test", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "bzmpop_test", 0, -1, false)
    ...
    test "BZPOPMAX replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "bzpopmax_test")
        redis_members = Redix.command!(redis, ["ZRANGE", "bzpopmax_test", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "bzpopmax_test", 0, -1, false)
    ...
    test "BZPOPMIN replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "bzpopmin_test")
        redis_members = Redix.command!(redis, ["ZRANGE", "bzpopmin_test", "0", "-1"])
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "bzpopmin_test", 0, -1, false)
    ...
    test "ZADD with options: NX only adds new members", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        assert {:ok, 1.0} == Veidrodelis.zscore(vdr_id(), 0, "nx_test", "existing")
        assert {3.0, ""} == Float.parse(Redix.command!(redis, ["ZSCORE", "nx_test", "new"]))
        assert {:ok, 3.0} == Veidrodelis.zscore(vdr_id(), 0, "nx_test", "new")
      end
    end
    ...
    test "ZADD with options: XX only updates existing members", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score_existing} = Veidrodelis.zscore(vdr_id(), 0, "xx_test", "existing")
        {:ok, ts_score_new} = Veidrodelis.zscore(vdr_id(), 0, "xx_test", "new")
    ...
    test "ZADD with options: GT only updates if new score greater", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "gt_test", "member")
    ...
    test "ZADD with options: LT only updates if new score less", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "lt_test", "member")
    ...
    test "ZADD with options: INCR increments score", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "incr_test", "member")
    ...
    test "ZINCRBY increments existing member in existing key", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "zincrby_existing", "counter")
    ...
    test "ZINCRBY creates member in existing key", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_count} = Veidrodelis.zcard(vdr_id(), 0, "zincrby_new_member")
        redis_score = Redix.command!(redis, ["ZSCORE", "zincrby_new_member", "new_member"])
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "zincrby_new_member", "new_member")
    ...
    test "ZINCRBY creates key and member when key doesn't exist", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_count} = Veidrodelis.zcard(vdr_id(), 0, "zincrby_new_key")
        redis_score = Redix.command!(redis, ["ZSCORE", "zincrby_new_key", "member1"])
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "zincrby_new_key", "member1")
    ...
    test "ZINCRBY decrements with negative increment", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score} = Veidrodelis.zscore(vdr_id(), 0, "zincrby_decr", "score")
    ...
    test "ZREMRANGEBYSCORE with exclusive min boundary", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "excl_min", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE with exclusive max boundary", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "excl_max", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE with both exclusive boundaries", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "excl_both", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE from -inf to value", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "inf_min", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE from value to +inf", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "inf_max", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE from -inf to +inf removes all", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "inf_all")
    ...
    test "ZREMRANGEBYLEX with inclusive range", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "lex_incl", 0, -1, false)
    ...
    test "ZREMRANGEBYLEX with exclusive range", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "lex_excl", 0, -1, false)
    ...
    test "ZREMRANGEBYLEX with - (min) boundary", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "lex_min", 0, -1, false)
    ...
    test "ZREMRANGEBYLEX with + (max) boundary", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "lex_max", 0, -1, false)
    ...
    test "ZREMRANGEBYLEX from - to + removes all", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "lex_all")
    ...
    test "ZADD with infinity scores", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "inf_scores", 0, -1, false)
    ...
    test "ZREMRANGEBYSCORE with infinity score members", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "inf_members", 0, -1, false)
    ...
    test "ZUNIONSTORE with WEIGHTS", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score_b} = Veidrodelis.zscore(vdr_id(), 0, "union_weighted", "b")
    ...
    test "ZUNIONSTORE with AGGREGATE MIN", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score_b} = Veidrodelis.zscore(vdr_id(), 0, "union_min_result", "b")
    ...
    test "ZINTERSTORE with WEIGHTS", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_card} = Veidrodelis.zcard(vdr_id(), 0, "inter_weighted")
        redis_score_b = Redix.command!(redis, ["ZSCORE", "inter_weighted", "b"])
        {:ok, ts_score_b} = Veidrodelis.zscore(vdr_id(), 0, "inter_weighted", "b")
    ...
    test "ZINTERSTORE with AGGREGATE MAX", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_score_b} = Veidrodelis.zscore(vdr_id(), 0, "inter_max_result", "b")
    ...
    test "ZREMRANGEBYRANK with negative indices", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "rank_neg", 0, -1, false)
    ...
    test "ZRANGEBYSCORE with scores replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        # Query range [2, 4]
        redis_result =
          Redix.command!(redis, ["ZRANGEBYSCORE", "zrangebyscore_test", "2", "4", "WITHSCORES"])

        {:ok, ts_result} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_test", 2.0, 4.0, true)
        ...
        redis_pairs =
          Enum.chunk_every(redis_result, 2) |> Enum.map(fn [m, s] -> {m, parse_score.(s)} end)
    ...
    test "ZRANGEBYSCORE without scores replicates correctly", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        redis_members =
          Redix.command!(redis, ["ZRANGEBYSCORE", "zrangebyscore_noscore", "2", "4"])

        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_noscore", 2.0, 4.0, false)
    ...
    test "ZRANGEBYSCORE with negative scores", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_neg", -3.0, 0.0, false)
    ...
    test "ZRANGEBYSCORE with floating point scores", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        redis_members =
          Redix.command!(redis, ["ZRANGEBYSCORE", "zrangebyscore_float", "2.0", "4.0"])

        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_float", 2.0, 4.0, false)
    ...
    test "ZRANGEBYSCORE with min equals max", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_equal", 2.0, 2.0, false)
    ...
    test "ZRANGEBYSCORE with empty range", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_empty", 2.0, 4.0, false)
    ...
    test "ZRANGEBYSCORE on non-existent key", %{redis: redis} do
      assert_within 1000 do
        ...
        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "nonexistent_zset", 1.0, 10.0, false)
    ...
    test "ZRANGEBYSCORE with large score range", %{redis: redis} do
      ...
      assert_within 1000 do
        # Scores 25-75 inclusive
        expected_count = 51

        redis_members =
          Redix.command!(redis, ["ZRANGEBYSCORE", "zrangebyscore_large", "25", "75"])

        {:ok, ts_members} =
          Veidrodelis.zrangebyscore(vdr_id(), 0, "zrangebyscore_large", 25.0, 75.0, false)
    ...
    test "ZPOPMAX with count", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "popmax_count", 0, -1, false)
    ...
    test "ZPOPMIN with count", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_members} = Veidrodelis.zrange(vdr_id(), 0, "popmin_count", 0, -1, false)
    ...
    test "ZRANK returns correct rank in ascending order", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_one} = Veidrodelis.zrank(vdr_id(), 0, "zrank_test", "one")
        redis_rank_three = Redix.command!(redis, ["ZRANK", "zrank_test", "three"])
        {:ok, ts_rank_three} = Veidrodelis.zrank(vdr_id(), 0, "zrank_test", "three")
        redis_rank_four = Redix.command!(redis, ["ZRANK", "zrank_test", "four"])
        {:ok, ts_rank_four} = Veidrodelis.zrank(vdr_id(), 0, "zrank_test", "four")
    ...
    test "ZRANK returns nil for non-existent member", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank} = Veidrodelis.zrank(vdr_id(), 0, "zrank_missing", "nonexistent")
    ...
    test "ZRANK returns nil for non-existent key", %{redis: redis} do
      assert_within 1000 do
        ...
        {:ok, ts_rank} = Veidrodelis.zrank(vdr_id(), 0, "nonexistent_key", "member")
    ...
    test "ZRANK with duplicate scores returns rank based on member order", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_a} = Veidrodelis.zrank(vdr_id(), 0, "zrank_dup", "a")
        redis_rank_b = Redix.command!(redis, ["ZRANK", "zrank_dup", "b"])
        {:ok, ts_rank_b} = Veidrodelis.zrank(vdr_id(), 0, "zrank_dup", "b")
        redis_rank_c = Redix.command!(redis, ["ZRANK", "zrank_dup", "c"])
        {:ok, ts_rank_c} = Veidrodelis.zrank(vdr_id(), 0, "zrank_dup", "c")
    ...
    test "ZRANK with negative scores", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_a} = Veidrodelis.zrank(vdr_id(), 0, "zrank_neg", "a")
        redis_rank_d = Redix.command!(redis, ["ZRANK", "zrank_neg", "d"])
        {:ok, ts_rank_d} = Veidrodelis.zrank(vdr_id(), 0, "zrank_neg", "d")
    ...
    test "ZREVRANK returns correct rank in descending order", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_four} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_test", "four")
        redis_rank_three = Redix.command!(redis, ["ZREVRANK", "zrevrank_test", "three"])
        {:ok, ts_rank_three} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_test", "three")
        redis_rank_one = Redix.command!(redis, ["ZREVRANK", "zrevrank_test", "one"])
        {:ok, ts_rank_one} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_test", "one")
    ...
    test "ZREVRANK returns nil for non-existent member", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_missing", "nonexistent")
    ...
    test "ZREVRANK returns nil for non-existent key", %{redis: redis} do
      assert_within 1000 do
        ...
        {:ok, ts_rank} = Veidrodelis.zrevrank(vdr_id(), 0, "nonexistent_key", "member")
    ...
    test "ZREVRANK with duplicate scores returns rank based on member order", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_c} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_dup", "c")
        redis_rank_b = Redix.command!(redis, ["ZREVRANK", "zrevrank_dup", "b"])
        {:ok, ts_rank_b} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_dup", "b")
        redis_rank_a = Redix.command!(redis, ["ZREVRANK", "zrevrank_dup", "a"])
        {:ok, ts_rank_a} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_dup", "a")
    ...
    test "ZREVRANK with negative scores", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_rank_d} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_neg", "d")
        redis_rank_a = Redix.command!(redis, ["ZREVRANK", "zrevrank_neg", "a"])
        {:ok, ts_rank_a} = Veidrodelis.zrevrank(vdr_id(), 0, "zrevrank_neg", "a")
    ...
    test "ZRANK and ZREVRANK are consistent inverses", %{redis: redis} do
      ...
      assert_within 1000 do
        ...
        {:ok, ts_size} = Veidrodelis.zcard(vdr_id(), 0, "rank_inverse")

        # ZRANK + ZREVRANK should equal size - 1
        redis_rank = Redix.command!(redis, ["ZRANK", "rank_inverse", "two"])
        {:ok, ts_rank} = Veidrodelis.zrank(vdr_id(), 0, "rank_inverse", "two")
        redis_revrank = Redix.command!(redis, ["ZREVRANK", "rank_inverse", "two"])
        {:ok, ts_revrank} = Veidrodelis.zrevrank(vdr_id(), 0, "rank_inverse", "two")
