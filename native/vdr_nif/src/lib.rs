...
#[rustler::nif]
fn compress<'a>(env: Env<'a>, data: Binary) -> Result<Binary<'a>, (Atom, Atom)> {
...
#[rustler::nif]
fn decompress<'a>(env: Env<'a>, compressed_data: Binary, uncompressed_size: usize) -> Result<Binary<'a>, (Atom, Atom)> {
